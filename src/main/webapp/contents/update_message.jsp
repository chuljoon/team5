            ...
            <div class="col-md-12 text-center">
              <c:choose>
                ...
                <span class="icon-check_circle display-3 text-success"></span>
                  <p class="lead mb-5">컨텐츠를 수정했습니다.</p>
                </c:when>
                <c:otherwise>
                <span class="icon-warning display-3" style="color: red;"></span>
                  <p class="lead mb-5">컨텐츠 수정에 실패했습니다.</p>
                </c:otherwise>
              </c:choose>
              <button type='button' onclick="location.href='./read.do?contentsno=${param.contentsno}&s_categoryno=${param.s_categoryno}&word=${param.word}&nowPage=${param.nowPage}'">수정된 컨텐츠 확인</button>
