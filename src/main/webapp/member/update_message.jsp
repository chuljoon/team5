      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">회원 삭제</strong>
          </div>
        </div>
      </div>
    </div>
  ...
  <DIV class='col-md-12 text-center'>
    ...
    <c:choose>
      ...
      <span class="icon-error display-3" ></span>
        <p>관리자 정보 수정에 실패했습니다.</p>
        <p>다시한번 시도해주세요.</p>
      </c:when>
      <c:when test="${param.count == 1}">
      <span class="icon-check_circle display-3 text-success"></span>
        <p>관리자 정보 수정에 성공했습니다.</p>
      </c:when>
    </c:choose>    
    <button type='button' onclick="location.href='./read.do?member=${param.memberno}'">수정 확인</button>
