...
<DIV class='row'>알림</DIV>
  <DIV class='col-md-12 text-center'>
    <span class="icon-error display-3" ></span>
      <h2 class="display-3 text-black">관리자 로그인이 필요합니다.</h2>
        <p class="">
          관리자로 로그인 시 열람이 가능합니다.
        </p>
        <p class="">
          <A href='${pageContext.request.contextPath}/admin/login.do' class="">
            관리자 로그인을 하시려면 여기를 클릭하세요.</A>
        </p>
        <p class="lead mb-5">
