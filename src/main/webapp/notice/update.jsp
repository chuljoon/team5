              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <label for="title" class="text-black">제목</label>
                   <input type='text' class="form-control input-lg" name='title' id='title' value='${noticeVO.title}' required="required" style='width: 80%;'>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-11">
                ...
                <div class="form-group row">
                  <div class="col-lg-4">
                   ...
                   <button type="button" onclick="location.href='./list_paging.do?nowPage=${param.nowPage }'">취소[목록]</button>   
              </div>
                </div>
              </div>
            </form>
