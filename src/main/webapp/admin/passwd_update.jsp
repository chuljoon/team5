...
<DIV class='content'>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <a href='${pageContext.request.contextPath}/admin/list.do' >Admin</a><span class="mx-2 mb-0">/</span> 
  ...
  <FORM name='frm' method='POST' action='./passwd_update.do' onsubmit="return send();" class="form-horizontal">
    ...
    <div class="form-group">
      <label for="a_passwd" class="col-md-6 control-label">현재 패스워드</label>    
      <div class="col-md-6">
        <input type='password' class="form-control input-md" name='a_passwd' id='a_passwd' value='' required="required" style='width: 50%;' placeholder="패스워드">
      </div>
    </div>   
                    
    <div class="form-group">
      <label for="a_passwd" class="col-md-6 control-label">새로운 패스워드</label>    
      <div class="col-md-6">
