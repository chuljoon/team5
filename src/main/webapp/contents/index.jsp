...
<DIV class='content' style='width: 100%;'>  
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><A href="../index.do">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">콘서트</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 mb-5">
                ...
                <A href="/info/contents/list_all_category.do">전체 |</A>
                <A href="/info/contents/list_by_category.do?s_categoryno=1">아이돌 |</A>
                <A href="/info/contents/list_by_category.do?s_categoryno=2">팬클럽/팬미팅</A></h2></div>
                <div class="d-flex">
                </div>
              </div>
            </div>
