...
<script type="text/javascript">
  ...
  function checkEmail() {
    var frm = $('#frm');
    var params = 'a_email=' + $('#a_email', frm).val(); // #: a_email
    // alert('params: ' + params);
  ...
  function checkNickname() {
    var frm = $('#frm');
    var params = 'a_nickname=' + $('#a_nickname', frm).val(); // #: a_nickname
    // alert('params: ' + params);
  ...
  <!-- Modal -->
    ...
    <div class="site-section">
      <DIV class='container'>
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="border p-4 rounded" role="alert">
              이미 회원이시다면 <a
                href="${pageContext.request.contextPath }/admin/login.do">여기</a>
              를 눌러 로그인해주세요!
            </div>
          </div>
        </div>
        ...
        <DIV class='title_line'>관리자 생성</DIV>
        <FORM name='frm' id='frm' method='POST' action='./create.do'
          onsubmit="return send();" class="form-horizontal">
          <div class="row">
            <div class="col-md-6 mb-5 mb-md-0">
              <h2 class="h3 mb-3 text-black">관리자 생성</h2>
              <div class="p-3 p-lg-5 border">
                <div class="form-group">
                  <label for="a_name" class="text-black">성명 <span
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="a_email" class="text-black">이메일(Email)
                    </label> <input type='text' class="form-control"
                      name='a_email' id='a_email' value='abc@abc.com'
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="a_nickname" class="text-black">닉네임
                      <span class="text-danger">*</span>
                    </label> <input type='text' class="form-control"
                      name='a_nickname' id='a_nickname' value='멋쟁이'
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="a_passwd" class="text-black">패스워드
                      / 패스워드 확인 <span class="text-danger">*</span>
                    </label> <input type='password' class="form-control"
                      name='a_passwd' id='a_passwd' value='1234'
                      required="required" style='width: 50%;'
                      placeholder="패스워드"> <input type="password"
                      class="form-control" name='a_passwd2'
                      id='a_passwd2' value='1234' required="required"
              ...
              <div class="row mb-5">
                <div class="col-md-12">
                  ...
                  <div class="p-3 p-lg-5 border">
                    <div class="form-group row">
                      <div class="col-md-12">
                        <label for="a_age" class="text-black">나이
                          <span class="text-danger">*</span>
                        </label> <input type='text' class="form-control"
                          name='a_age' id='a_age' value='20'
                    ...
                    <div class="form-group">
                      <div class="col-md-offset-2 col-md-10">
                        <button type="submit"
                          class="btn btn-primary btn-md">생성</button>
                        <button type="button"
